...
function trataErro(err){
    switch(err.code){
        case 'ENOENT':
            throw new Error(chalk.yellow(err.code, "Caminho especificado ta errado"))
        default:
            throw new Error(chalk.yellow(err.code, "erro não especificado"))
    }
}
